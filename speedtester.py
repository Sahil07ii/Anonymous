...
lab = Label(sp,text="Internet Speed Test", font=("Time New Roman",30, "bold"),bg="brown",fg="White")
...
button = Button(sp,text="Check Speed",font=("Time New Roman",30, "bold"),relief=RAISED,bg="green",command=speedcheck)
